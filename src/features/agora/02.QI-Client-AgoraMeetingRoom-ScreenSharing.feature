@agoraTest2
@jobCTest
Feature: Client Agora Screensharing
    Scenario:Screensharing from customer
        ...
        And Verify that the screen is shared from "Interviewer1"
        And Verify that the monitor name is present for "Interviewer1"
        And Verify that the "Interviewer1" name is present
