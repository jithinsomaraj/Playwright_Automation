...
const COMMANDS = [
    'npm run agoraTest1_report',
    'npm run agoraTest2_report',
    'npm run agoraTest3_report',
    'npm run agoraTest4_report',
    'npm run agoraTest5_report',
    'npm run agoraTest6_report',
    'npm run agoraTest7_report'
];
